...
class Skeleton extends Creature {
    public override function init() {
        ...
        stats.setAttack(5);
        stats.setSpeed(50);
        actions.push(new worldElements.creatures.actions.RangedSpecialDirectionalAttack(this, 0.6, "{attacker} threw a bone at {target}. It's a critical hit for {damage} damage.",
